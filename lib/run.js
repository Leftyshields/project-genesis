 ...
 * @returns {{ root: object, overlay: object, result?: string|Buffer }} - root (organism node),
 *   overlay (status overlay with molecule node set), result (molecule return value or undefined if failed).
 */
